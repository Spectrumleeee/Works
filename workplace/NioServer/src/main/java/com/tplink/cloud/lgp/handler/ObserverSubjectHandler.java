...
public class ObserverSubjectHandler implements Handler {
	...
	public void handleRead(SelectionKey key) throws IOException {
		...
		if(operation.array()[0] == '1'){
			// if Operation Code is 1,  we will create a concrete observer and register it
			...
			for(String subjectId : subjects.keySet())
				if(subscri[i++] == '1'){
					System.out.println(new String(clientId.array(), 0, idLen) + " has subscribed the subject : " + subjectId);
